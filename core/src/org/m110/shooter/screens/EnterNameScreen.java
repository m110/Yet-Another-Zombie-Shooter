...
public class EnterNameScreen extends ShooterScreen {
    ...
    private final String enterNameText = "Enter your name";
    private float width;
    ...
    public EnterNameScreen(final Shooter shooter) {
        ...
        layout.setText(font, enterNameText);
        width = layout.width;
    }
    ...
    public void render(float delta) {
        ...
        batch.begin();
        font.draw(batch, enterNameText, Gdx.graphics.getWidth() / 2.0f - width / 2.0f,
                Gdx.graphics.getHeight() / 2.0f + font.getLineHeight() + 80.0f);
        batch.end();

        renderer.setColor(Color.WHITE);
        renderer.begin(ShapeRenderer.ShapeType.Filled);
        renderer.rect(textField.getX() - 2.0f, textField.getY() - 2.0f,
