...
public class Collision {
    ...
    public Collision(GameScreen game, TiledMapTileLayer collisions) {
        this.game = game;
    ...
    public boolean collidesWithWall(float x, float y, Actor actor) {
        ...
        int y1 = (int)(y / game.getTileHeight());

        int x2 = (int)((x + actor.getWidth()) / game.getTileWidth());
        int y2 = (int)((y + actor.getHeight()) / game.getTileHeight());

        if (collisions.getCell(x1, y1) == null && collisions.getCell(x2, y2) == null &&
            collisions.getCell(x2, y1) == null && collisions.getCell(x1, y2) == null) {
